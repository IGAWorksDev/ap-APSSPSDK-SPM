...
final public class PangleVideoMixAdapter: APSSPVideoMixAdAdapterInappBiddingProtocol {
    public var rootViewController: UIViewController?
    public var videoMixDelegate: APSSPVideoMixAdAdapterDelegate?
    public var videoMixAdType: APSSPVideoMixAdType = .InterstitialVideo
    private var placementDic: [String: String] = [:]
    private var interstitialVideoAdapter: PangleAdsInterstitialVideoAdapter?
    private var rewardVideoAdapter: PangleRewardVideoAdapter?
    ...
    public func connectVideoMixDelegate(delegate: APSSPVideoMixAdAdapterDelegate) {
        ...
        case .InterstitialVideo:
            interstitialVideoAdapter = PangleAdsInterstitialVideoAdapter(placementDic: placementDic, rootViewController: rootViewController, info: [:])
            interstitialVideoAdapter?.connectDelegate(delegate: self)
        case .RewardVideo:
            rewardVideoAdapter = PangleRewardVideoAdapter(placementDic: placementDic, rootViewController: rootViewController, info: [:])
    ...
    public func disconnectVideoMixDelegate() {
        interstitialVideoAdapter = nil; rewardVideoAdapter = nil; videoMixDelegate = nil
    }
...
extension PangleVideoMixAdapter: APSSPInterstitialVideoAdapterDelegate {
...
extension PangleVideoMixAdapter: APSSPRewardVideoAdapterDelegate {
    ...
    public func rewardVideoCompleted() { videoMixDelegate?.videoMixAdCompleteTrackingEvent(adNetworkNo: APSSPMediationCompany.Pangle.rawValue, isCompleted: true, type: videoMixAdType) }
}
