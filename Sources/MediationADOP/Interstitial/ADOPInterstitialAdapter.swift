...
final public class ADOPInterstitialAdapter: APSSPInterstitialAdapterProtocol {

    public var rootViewController: UIViewController?
    
    public var delegate: APSSPInterstitialAdapterDelegate?
    
    private var interstitialAd: ADOPMediationInterstitialAd?
    ...
    public init(placementDic: [String: String], rootViewController: UIViewController?, info: [String : Any?]) {
        ...
        interstitialAd = ADOPMediationInterstitialAd(placementId: placementId)
...
extension ADOPInterstitialAdapter: APSSPInterstitialAdapterDelegate {
