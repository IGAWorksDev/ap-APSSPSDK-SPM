//
//  ADOPMediationNativeAdView.swift
//  MediationADOP
//
...
@objc
public final class APSSPADOPNativeAdRenderer: NSObject, APSSPNativeRenderer {
    @objc public var contentView: UIView?
    public var admobNativewAdView: NativeAdView?
}


final class ADOPMediationNativeAdView: UIView {
    
    weak var delegate: APSSPNativeViewAdapterDelegate?
    
    var admobRenderer: APSSPADOPNativeAdRenderer?
...
//    private var nativeAdView: NativeAdView = NativeAdView()
    ...
    init(placementId: String, rootViewController: UIViewController?, render: AnyObject) {
        ...
        guard let render = render as? APSSPADOPNativeAdRenderer else { return }
        admobRenderer = render

    }
    
    deinit {
        print("❤️❤️ ADOP NativeView 제거 ❤️❤️")
    }
