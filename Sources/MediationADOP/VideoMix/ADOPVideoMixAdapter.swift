...
final public class ADOPVideoMixAdapter: APSSPVideoMixAdAdapterProtocol {
    ...
    private var interstitialAdapter: ADOPInterstitialAdapter?
    private var interstitialVideoAdapter: ADOPInterstitialVideoAdapter?
    private var rewardVideoAdapter: ADOPRewardVideoAdapter?
    ...
    public func connectVideoMixDelegate(delegate: APSSPVideoMixAdAdapterDelegate) {
        ...
        case .Interstitial: interstitialAdapter = ADOPInterstitialAdapter(placementDic: placementDic, rootViewController: rootViewController, info: [:]); interstitialAdapter?.connectDelegate(delegate: self)
        case .InterstitialVideo: interstitialVideoAdapter = ADOPInterstitialVideoAdapter(placementDic: placementDic, rootViewController: rootViewController, info: [:]); interstitialVideoAdapter?.connectDelegate(delegate: self)
        case .RewardVideo: rewardVideoAdapter = ADOPRewardVideoAdapter(placementDic: placementDic, rootViewController: rootViewController, info: [:]); rewardVideoAdapter?.connectDelegate(delegate: self)
        @unknown default:
            break
        }
    }
...
extension ADOPVideoMixAdapter: APSSPInterstitialAdapterDelegate {
...
extension ADOPVideoMixAdapter: APSSPInterstitialVideoAdapterDelegate {
...
extension ADOPVideoMixAdapter: APSSPRewardVideoAdapterDelegate {
    ...
    public func rewardVideoCompleted() { videoMixDelegate?.videoMixAdCompleteTrackingEvent(adNetworkNo: APSSPMediationCompany.ADOP.rawValue, isCompleted: true, type: videoMixAdType) }
}
