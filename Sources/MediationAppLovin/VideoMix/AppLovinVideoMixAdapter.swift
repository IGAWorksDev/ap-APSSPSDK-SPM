...
final public class AppLovinVideoMixAdapter: APSSPVideoMixAdAdapterProtocol {
    ...
    private var interstitialAdapter: AppLovinInterstitialAdapter?
    private var interstitialVideoAdapter: AppLovinInterstitialVideoAdapter?
    private var rewardVideoAdapter: AppLovinRewardVideoAdapter?
    ...
    public func connectVideoMixDelegate(delegate: APSSPVideoMixAdAdapterDelegate) {
        ...
        case .Interstitial: interstitialAdapter = AppLovinInterstitialAdapter(placementDic: placementDic, rootViewController: rootViewController, info: [:]); interstitialAdapter?.connectDelegate(delegate: self)
        case .InterstitialVideo: interstitialVideoAdapter = AppLovinInterstitialVideoAdapter(placementDic: placementDic, rootViewController: rootViewController, info: [:]); interstitialVideoAdapter?.connectDelegate(delegate: self)
        case .RewardVideo: rewardVideoAdapter = AppLovinRewardVideoAdapter(placementDic: placementDic, rootViewController: rootViewController, info: [:]); rewardVideoAdapter?.connectDelegate(delegate: self)
        @unknown default:
            break
        }
    }
...
extension AppLovinVideoMixAdapter: APSSPInterstitialAdapterDelegate {
...
extension AppLovinVideoMixAdapter: APSSPInterstitialVideoAdapterDelegate {
...
extension AppLovinVideoMixAdapter: APSSPRewardVideoAdapterDelegate {
    ...
    public func rewardVideoCompleted() { videoMixDelegate?.videoMixAdCompleteTrackingEvent(adNetworkNo: APSSPMediationCompany.AppLovin.rawValue, isCompleted: true, type: videoMixAdType) }
}
